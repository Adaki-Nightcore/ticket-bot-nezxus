...
export default class ReadyEvent extends BaseEvent {
	...
	public async execute()  {
		...
		let footer = locale.getSubValue("embeds", "openTicket", "footer", "text").replace("Nexus | Ticket", "");
		// Please respect the project by keeping the credits, (if it is too disturbing you can credit me in the "about me" of the bot discord)
		footer = `Nexus | Ticket ${footer.trim() !== "" ? `- ${footer}` : ""}`; // Please respect the LICENSE :D
		// Please respect the project by keeping the credits, (if it is too disturbing you can credit me in the "about me" of the bot discord)
		...
		\x1b[0m🌟  You can leave a star on GitHub: \x1b[37;46;1mhttps://discord.gg/Yj4P6VZ3wx \x1b[0m
		\x1b[0m⛅  Host your ticket-bot by being a sponsor from: \x1b[37;46;1mhttps://discord.gg/Yj4P6VZ3wx\x1b[0m\n`.replace(/\t/g, "")
		);
		...
		if (a) {
			...
			const sponsorsList = sponsors
				...
				.join(", ");
			process.stdout.write(`\x1b[0m💖  Thanks to our sponsors: Nexus Shop\n`);
		}
